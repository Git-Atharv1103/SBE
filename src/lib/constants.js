...
export const COMPANY_DETAILS = {
  ...
  subtitle: 'Commercial/Hotel Kitchen Equipment',
  ...
  address: 'Plot No. 42, Sector 10, PCNTDA, Bhosari, Pune - 411026, Maharashtra, India',
  phone: '+91 98220 54321 / +91 98500 12345',
  email: 'sales@shreebalajikitchenequipment.com',
...
export const DEFAULT_MASTER_PRODUCTS = [
  ...
  { materialName: 'Leg Pipe', category: 'Pipe', calculationType: 'Pipe', materialType: 'Framework Leg', grade: '304', gauge: '', pipeSize: '', defaultUnitWeight: null, allowCustomUnitWeight: false, counterTypes: [...DISH_RACK_KEYS, 'Pot Rack', 'Dining Table', 'Bench', ...STORAGE_BIN_SUBTYPES, ...COUNTER_KEYS, 'Trolley', ...FRIDGE_SUBTYPES, 'Stainless Steel Kitchen', 'Sink Unit', 'Sink Unit with Table', 'Soiled Dish Table', ...GAS_RANGE_SUBTYPES, 'Dosa Bhatti', 'SS Tandoor', ...SHAWARMA_SUBTYPES, 'Chapati Puffer Plate', 'Pick Up Counter'], order: 1, status: 'Active', unit: 'kg', price: 270, description: 'SS Main Structural Framework Leg Pipe' },
  { materialName: 'Top Support Pipe', category: 'Pipe', calculationType: 'Pipe', materialType: 'Top Reinforcement', grade: '304', gauge: '', pipeSize: '', defaultUnitWeight: null, allowCustomUnitWeight: false, counterTypes: [...DISH_RACK_KEYS, 'Dining Table', 'Bench', ...STORAGE_BIN_SUBTYPES, ...COUNTER_KEYS, 'Trolley', ...FRIDGE_SUBTYPES, 'Sink Unit', 'Sink Unit with Table', 'Soiled Dish Table', ...GAS_RANGE_SUBTYPES, 'Dosa Bhatti', 'SS Tandoor', 'Chapati Puffer Plate'], order: 2, status: 'Active', unit: 'kg', price: 270, description: 'SS Top Frame Under Support Pipe' },
  { materialName: 'Shelf Support Pipe', category: 'Pipe', calculationType: 'Pipe', materialType: 'Shelf Reinforcement', grade: '304', gauge: '', pipeSize: '', defaultUnitWeight: null, allowCustomUnitWeight: false, counterTypes: [...DISH_RACK_KEYS, ...STORAGE_BIN_SUBTYPES, ...COUNTER_KEYS, 'Trolley', ...FRIDGE_SUBTYPES, ...GAS_RANGE_SUBTYPES, 'Dosa Bhatti', 'SS Tandoor', ...SHAWARMA_SUBTYPES, 'Chapati Puffer Plate'], order: 3, status: 'Active', unit: 'kg', price: 270, description: 'SS Shelf Support Cross Framework Pipe' },
  { materialName: 'Under Support Pipe', category: 'Pipe', calculationType: 'Pipe', materialType: 'Base Reinforcement', grade: '304', gauge: '', pipeSize: '', defaultUnitWeight: null, allowCustomUnitWeight: false, counterTypes: [...DISH_RACK_KEYS, ...STORAGE_BIN_SUBTYPES, ...COUNTER_KEYS, 'Trolley', ...FRIDGE_SUBTYPES, ...GAS_RANGE_SUBTYPES, 'Dosa Bhatti', 'SS Tandoor', 'Chapati Puffer Plate'], order: 4, status: 'Active', unit: 'kg', price: 270, description: 'SS Base Reinforcement Under Support Pipe' },
  { materialName: 'Bush', category: 'Purchased', calculationType: 'Purchased', materialType: 'Hardware', grade: '304', gauge: '', pipeSize: '', defaultUnitWeight: null, allowCustomUnitWeight: false, counterTypes: [...DISH_RACK_KEYS, 'Pot Rack', 'Dining Table', 'Bench', ...COUNTER_KEYS, ...FRIDGE_SUBTYPES, 'Stainless Steel Kitchen', 'Sink Unit', 'Sink Unit with Table', 'Soiled Dish Table', ...GAS_RANGE_SUBTYPES, 'Dosa Bhatti', 'Chapati Puffer Plate'], order: 1, status: 'Active', unit: 'Piece', price: 50, description: 'Heavy duty leg insert bush' },
  ...
  // 4. BENCH
  // ==========================================
  { materialName: 'Top', category: 'Sheet', calculationType: 'Sheet', materialType: 'Top Surface', grade: '304', gauge: '', pipeSize: '', defaultUnitWeight: null, allowCustomUnitWeight: false, counterTypes: ['Bench', ...COUNTER_KEYS, 'Trolley', 'Stainless Steel Kitchen', 'Sink Unit', 'Sink Unit with Table', ...GAS_RANGE_SUBTYPES, 'Dosa Bhatti', 'SS Tandoor', 'Table Top Shawarma Cabin', 'Half Shawarma Cabin', 'Chapati Puffer Plate'], order: 1, status: 'Active', unit: 'kg', price: 250, description: 'SS Seating / Working Top Surface Sheet' },
