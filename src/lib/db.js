...
const ProjectSchema = new mongoose.Schema(
  {
    ...
    sellingPercentage: { type: Number, default: 0 },
    sellingAmount: { type: Number, default: 0 },
    sellingPrice: { type: Number, default: 0 },
    discount: { type: Number, default: 0 },
    gst: { type: Number, default: 18 },

    // Calculated outcomes & weight breakdowns
    totalSheetWeight: { type: Number, default: 0 },
    totalPipeWeight: { type: Number, default: 0 },
    totalAngleWeight: { type: Number, default: 0 },
...
export async function createProject(projectData) {
  ...
  const record = {
    ...
    labourRate: Number(projectData.labourRate || 0),
    labourCost: Number(projectData.labourCost || 0),
    sellingPercentage: Number(projectData.sellingPercentage || 0),
    sellingAmount: Number(projectData.sellingAmount || 0),
    sellingPrice: Number(projectData.sellingPrice || 0),
    discount: Number(projectData.discount || 0),
    gst: Number(projectData.gst !== undefined ? projectData.gst : 18),
    totalSheetWeight: Number(projectData.totalSheetWeight || 0),
    totalPipeWeight: Number(projectData.totalPipeWeight || 0),
    totalAngleWeight: Number(projectData.totalAngleWeight || 0),
    ...
    taxableAmount: Number(projectData.taxableAmount || projectData.sellingPrice || 0),
    gstAmount: Number(projectData.gstAmount || 0),
    totalAmount: Number(projectData.totalAmount || projectData.finalTotal || projectData.grandTotal || 0),
    grandTotal: Number(projectData.grandTotal || projectData.finalTotal || projectData.totalAmount || 0),
    finalTotal: Number(projectData.finalTotal || projectData.grandTotal || projectData.totalAmount || 0),
